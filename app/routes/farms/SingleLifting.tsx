                            ...
                            <div className="flex items-baseline gap-1">
                                ...
                                <div className="bg-green-50 dark:bg-green-950/20 border border-green-100 dark:border-green-900/30 p-5 rounded-xl">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span className="text-2xl font-black text-green-700 dark:text-green-400">{view?.total?.total_medicine_price?.toLocaleString("en-IN", { minimumFractionDigits: 2 }) || 0}</span>
                                    </div>
                                </div>
